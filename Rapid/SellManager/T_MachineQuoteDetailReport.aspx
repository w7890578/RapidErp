<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T_MachineQuoteDetailReport.aspx.cs"
    Inherits="Rapid.SellManager.T_MachineQuoteDetailReport" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Detail(productnumber, version) {
            window.location.href = "MachineQuoteDetailReport.aspx?ProductNumber=" + productnumber+"&Version="+version;
        }
...
<body>
    ...
    &nbsp;&nbsp;客户名称：<asp:TextBox ID="txtCustomerName" runat="server"></asp:TextBox>
     &nbsp;&nbsp;报价人：<asp:TextBox ID="txtQuoteUser" runat="server"></asp:TextBox>&nbsp;&nbsp;<asp:Button
        ID="btnSearch" runat="server" Text="查询" OnClick="btnSearch_Click" Style="margin-right: 10px;" />
    <asp:Button ID="btnEmp" runat="server" Text="导出" OnClick="btnEmp_Click" Style="margin-right: 10px;"/>
    &nbsp;&nbsp;
        <a href="MachineQuoteDetailReportNew.aspx" >明细</a>
        ...
        <table class="border" cellpadding="1" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <td class="tdOperar" style="width:80px;" align="center">
                        操作
                    </td>
                </tr>
            </thead>
                ...
                <asp:Repeater runat="server" ID="rpList">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <a href="###" onclick="Detail(' <%#Eval("产成品编号") %>',' <%#Eval("版本") %>')">详细</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
