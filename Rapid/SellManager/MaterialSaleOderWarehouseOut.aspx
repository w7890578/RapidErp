<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialSaleOderWarehouseOut.aspx.cs"
    Inherits="Rapid.SellManager.MaterialSaleOderWarehouseOut" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        //详细跳转
        function Transfer(warehousenumber, Type, changedirection) {
            window.location.href = "../StoreroomManager/ToolMaterialWarehouseLogDetail.aspx?WarehouseNumber=" + warehousenumber + "&Type=" + encodeURI(Type) + "&ChangeDirection=" + changedirection + "&IsXS=true";
        }
        //确认
        function Determine(warehousenumber) {
            ...
            $.get("MaterialSaleOderWarehouseOut.aspx?sq=" + new Date(), { IsDetermine: "true", Warehousenumber: warehousenumber }, function (result) {
                if (result == "1") {
                    alert("确认成功");
                    $("#btnSearch").click();
                    return;
        ...
        function Delete(warehousenumber) {
            ...
            $.get("MaterialSaleOderWarehouseOut.aspx?sq=" + new Date(), { IsDelete: "true", Warehousenumber: warehousenumber }, function (result) {
                if (result == "1") {
                    alert("删除成功");
                    $("#btnSearch").click();
                    return;
        ...
        $(function () {
            $("#btnAdd").click(function () {
                OpenDialog("../SellManager/AddOrEditMaterialSaleOderWarehouseOut.aspx?IsXS=true", "btnSearch", "240", "600");
            });
        })
    </script>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4" id="navHead">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;销售管理&nbsp;&nbsp;>&nbsp;&nbsp;原材料销售出库</span>
                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: left">
                                                    ...
                                                    <div>
                                                        ...
                                                        <%
                                                            bool exp = Rapid.ToolCode.Tool.GetUserMenuFunc("L0121", "Add");
                                                        %>
                                                        <div style="display: <%=exp?"":"none"%>;">
                                                ...
                                                <td colspan="8">
                                                    <div>
                                                        <table class="tablesorter" cellpadding="1" cellspacing="1">
                                                                ...
                                                                <asp:Repeater ID="rpList" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a href="###" onclick="Transfer('<%#Eval("WarehouseNumber")%>','<%#Eval("Type")%>', '<%#Eval("ChangeDirection")%>')">详细</a> <span style="display: <%#Eval("IsConfirm").ToString ().Equals ("是")?"none":"inline"%>;">&nbsp;&nbsp; <a href="###" onclick="Delete('<%#Eval("WarehouseNumber")%>')">删除</a>
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td colspan="7" style="background-color: #F3FFE3; padding-top: 10px; padding-left: 10px; padding-right: 10px;">
