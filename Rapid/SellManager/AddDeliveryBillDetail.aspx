<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddDeliveryBillDetail.aspx.cs" Inherits="Rapid.SellManager.AddDeliveryBillDetail" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOrdersNumber" runat="server" CssClass="input  required" size="25"></asp:TextBox>
