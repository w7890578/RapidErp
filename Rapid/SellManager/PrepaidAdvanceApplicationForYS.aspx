<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrepaidAdvanceApplicationForYS.aspx.cs" Inherits="Rapid.SellManager.PrepaidAdvanceApplicationForYS" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnSQ").click(function () {
                ...
                //这是获取的值
                if (confirm("确定选中数据?")) {
                    $.get("PrepaidAdvanceApplicationForYS.aspx?time=" + new Date(), { sq: ConvertsContent(checkResult) }, function (result) {
                        if (result == "1") {
                            alert("申请成功");
                            $("#btnSearch").click();
                        }
            ...
            <table class="border" cellpadding="1" cellspacing="1" style="table-layout: fixed; word-break: break-all">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>合计</td>
                        <td></td>
                        <td><%=dtCount.Rows[0][3] %></td>
                        <td> <%=dtCount.Rows[0][8] %></td>
                        <td colspan="9"></td>
                    </tr>
                    <%} %>
                ...
                <tfoot>
                    <tr>
                        <td colspan="13">
                            <%=BLL.ToolManager.PagerGet("PrepaidAdvanceApplicationForYS.aspx",totalRecords,pageindex,pageSize) %>
                        </td>
                    </tr>
                </tfoot>
            </table>
