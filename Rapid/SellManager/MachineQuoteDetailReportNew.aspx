<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MachineQuoteDetailReportNew.aspx.cs" Inherits="Rapid.SellManager.MachineQuoteDetailReportNew" %>
...
<body>
    ...
    客户联系人:<asp:TextBox runat ="server" ID="txtContact"></asp:TextBox>&nbsp;&nbsp;
    <br />
    物料描述：<asp:TextBox id="txtDescrition" runat ="server"></asp:TextBox>&nbsp;&nbsp;
