<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditMachineOrderDetail.aspx.cs"
    EnableEventValidation="false" Inherits="Rapid.SellManager.AddOrEditMachineOrderDetail" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function() {
            var OdersNumber = $("#hdOderNumber").val();
            ...
            $("#btnSearch").click(function() {
                ...
                $.get("AddOrEditMachineOrderDetail.aspx", { time: new Date(),contion: contion, m: "m", OdersNumber: OdersNumber }, function(result) {
                    index = -1;
                    ...
                    $("#mText").html(result).find("tr").click(function() {
                        ...
                        if (number != "" && number != undefined && version != "" && version != undefined) {
                            ...
                            $.get("AddOrEditMachineOrderDetail.aspx", { time: new Date(), productNumber: number, version: version, OdersNumber: OdersNumber, IsGetCustomerProductNumber: "true" }, function(customerNumber) {
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr style="display:none;">
            ...
            <td>
                <div style="position: relative;">
                    <asp:TextBox ID="txtProductNumber" runat="server" CssClass="input " size="25"
                    ...
                    <div id="tempDiv" style="position: absolute; display: none; left: 0px; top: 21px;
                        ...
                        <span style="display: none; position: absolute; left: 233px; top: -1px; border-top: 1px solid green;
                    ...
                    <asp:Label ID="lbProductNumber" runat="server"> </asp:Label>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCustomerProductNumber" runat="server" CssClass="input"
                    size="25" ></asp:TextBox>
                <asp:Label ID="lbCustomerProductNumber" runat="server"> </asp:Label>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="lbDelivery" runat="server"></asp:Label>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="Label11" runat="server" Text="（*号为必填项）" ForeColor="Red"></asp:Label>
            </td>
        </tr>
    </table>
    </form>
