<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditMaterialSaleOderWarehouseOut.aspx.cs"
    Inherits="Rapid.SellManager.AddOrEditMaterialSaleOderWarehouseOut" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>原材料销售出库维护</title>
    ...
    <div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
            ...
            <tr id="trWarehouseNumber" runat="server">
                ...
                <td>
                    <asp:TextBox ID="txtWarehouseNumber" runat="server" CssClass="input" size="25" Visible="false"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpChangeDirection" runat="server" >
                        <asp:ListItem Value="出库" Text="出库">出库</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="drpType" runat="server" >
                     <asp:ListItem Value="销售出库（贸易）" Text="销售出库（贸易）">销售出库（贸易）</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
