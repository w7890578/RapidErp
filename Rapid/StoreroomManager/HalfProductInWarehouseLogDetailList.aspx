<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HalfProductInWarehouseLogDetailList.aspx.cs"
    Inherits="Rapid.StoreroomManager.HalfProductWarehouseLogDetailList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>半成品入库明细表</title>
    ...
    <script type="text/javascript">
        ...
        function GetQueryCondition() {
            var condition = " where 1=1 and (入库编号='" + warehousenumber + "')";
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_HalfProductInWarehouseLogDetail ";
            querySql = querySql + " " + GetQueryCondition();
     
            $.ajax({
                type: "Get",
                url: "HalfProductInWarehouseLogDetailList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/HalfProductInWarehouseLogDetailList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                OpenDialog("AddOrEditHalfInProductWarehouseLogDetail.aspx?WarehouseNumber=" + warehousenumber, "btnSearch", "350", "500");
            ...
            //进入页面加载数据
            $("#btnSearch").click();
            BindSelect("HalfLeadTime", "LeadTime");
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库存管理&nbsp;&nbsp;>&nbsp;&nbsp;半成品入库主表>&nbsp;&nbsp;半成品入库明细表</span>
                                </td>
                                                    ...
                                                    <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th sortname='入库编号'>
                                                                    入库编号<span><img src="../Img/bg.gif" id="sortImg" /></span>
                                                                </th>
                                                                <th sortname='开工单号'>
