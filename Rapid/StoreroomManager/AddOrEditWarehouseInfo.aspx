<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditWarehouseInfo.aspx.cs"
    Inherits="Rapid.StoreroomManager.AddOrEditWarehouseInfo" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr runat="server">
            ...
            <td>
                <asp:TextBox ID="txtWarehouseName" runat="server" CssClass="input required" size="25"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPosition" runat="server" CssClass="input required" size="25"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpType" runat="server" AutoPostBack="True">
                    <asp:ListItem Selected="True">产成品库</asp:ListItem>
                    <asp:ListItem>原材料库</asp:ListItem>
                    <asp:ListItem>半成品库</asp:ListItem>
                    <asp:ListItem>废品库</asp:ListItem>
                    <asp:ListItem>样品库</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
