<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HalfProductOutWarehouseLogDetailList.aspx.cs"
    Inherits="Rapid.StoreroomManager.HalfProductOutWarehouseLogDetailList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>半成品出库明细表</title>
    ...
    <script type="text/javascript">
        ...
        function GetQueryCondition() {
            var condition = " where 1=1 and (出库编号='" + warehousenumber + "') ";

            var ProductNumber = $("#ProductNumber").val();
            var MaterialNumber = $("#MaterialNumber").val();
            var SailOrderNumber = $("#SailOrderNumber").val();

            var leadTime = $("#LeadTime").val();
            var LeadTime = $("#LeadTime").find("option:selected").text();
            ...
            if (MaterialNumber != "" && MaterialNumber != null) {
                condition += " and (缺料原材料编号 like '%" + MaterialNumber + "%' or 缺料原材料编号 like '%" + MaterialNumber + "' or 缺料原材料编号 like '" + MaterialNumber + "%') ";
            }
            if (SailOrderNumber != "" && SailOrderNumber != null) {
                condition += " and (销售订单号 like '%" + SailOrderNumber + "%' or 销售订单号 like '%" + SailOrderNumber + "' or 销售订单号 like '" + SailOrderNumber + "%') ";
            }
            if (leadTime != "" && leadTime != null) {
                condition += " and (订单交期='" + LeadTime + "') ";
            }
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_HalfProductOutWarehouseLogDetail ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "HalfProductOutWarehouseLogDetailList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/HalfProductOutWarehouseLogDetailList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                OpenDialog("AddOrEditHalfOutProductWarehouseLogDetail.aspx?WarehouseNumber=" + warehousenumber, "btnSearch", "350", "500");
            ...
            BindSelect("HalfOutLeadtime", "LeadTime");
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库存管理&nbsp;&nbsp;>&nbsp;&nbsp;半成品出入库主表>&nbsp;&nbsp;半成品出库明细表</span>
                                </td>
                                    ...
                                    <div>
                                        ...
                                        <table class="pg_table">
                                            <tr>
                                                ...
                                                <td class="pg_talbe_content">
                                                    <input type="text" id="SailOrderNumber" />
                                                </td>
                                                <td class="pg_talbe_head">
                                                    订单交期：
                                                </td>
                                                    ...
                                                    <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th sortname='出库编号'>
                                                                    出库编号<span><img src="../Img/bg.gif" id="sortImg" /></span>
                                                                </th>
                                                                <th sortname='开工单号'>
                                                                    开工单号<span><img src="../Img/bg.gif" id="Img1" /></span>
                                                                </th>
                                                                <th sortname='产成品编号'>
                                                                    产成品编号<span><img src="../Img/bg.gif" id="Img3" /></span>
                                                                </th>
                                                                <th sortname='版本'>
                                                                    版本<span><img src="../Img/bg.gif" id="Img4" /></span>
                                                                </th>
                                                                <th sortname='缺料原材料编号'>
                                                                    缺料原材料编号<span><img src="../Img/bg.gif" id="Img5" /></span>
                                                                </th>
                                                                <th sortname='销售订单号'>
                                                                    销售订单号<span><img src="../Img/bg.gif" id="Img6" /></span>
                                                                </th>
                                                                <th sortname='订单交期'>
                                                                    订单交期<span><img src="../Img/bg.gif" id="Img8" /></span>
                                                                </th>
                                                                <th sortname='数量'>
