<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScarpWarehouseLogList.aspx.cs"
    Inherits="Rapid.ProduceManager.ScarpWarehouseLogList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ScarpWarehouseLogList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "ScarpWarehouseLogList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/ScarpWarehouseLogList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                OpenDialog("AddOrEditScarpWarehouseLog.aspx", "btnSearch", "260", "600");
            ...
            $("#btnCheck").click(function() {
                ...
                if (confirm("确定审核选择的数据?")) {
                    Check("../StoreroomManager/ScarpWarehouseLogList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            ...
            $("#btnSearch").click();
            //绑定出入库编号
            //            BindSelect("ScarpWarehouseLogWarehouseNumber", "WarehouseNumber");

            //仓库名称
            //            BindSelect("ScarpWarehouseLogWarehouseName", "WarehouseName");
            //位置
            BindSelect("ScarpWarehouseLogChangeDirection", "ChangeDirection");
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库存管理&nbsp;&nbsp;>&nbsp;&nbsp;废品出入库主表</span>
                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: left">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style="float: left; width: 65px; display: none;" id="divAudit" runat="server">
