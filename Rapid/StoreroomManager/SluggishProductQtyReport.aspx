<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SluggishProductQtyReport.aspx.cs"
    Inherits="Rapid.StoreroomManager.SluggishProductQtyReport" %>
    ...
    <div>
        ...
        <div id="divHeader" style="padding: 10px;">
            <div style="position: relative; float: left; margin-bottom: 10px">
                ...
                <asp:Label ID="Label2" runat="server" Text="客户产成品编号："></asp:Label>
                <asp:TextBox ID="txtCustomerProductNumber" runat="server"></asp:TextBox>
