<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditMarerialWarehouseLog.aspx.cs"
    Inherits="Rapid.StoreroomManager.AddOrEditMarerialWarehouseLog" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>原材料出入库信息维护</title>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpChangeDirection" runat="server" AutoPostBack="True" 
                    onselectedindexchanged="drpChangeDirection_SelectedIndexChanged" CssClass ="required">
