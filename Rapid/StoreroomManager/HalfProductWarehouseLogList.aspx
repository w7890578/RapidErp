<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HalfProductWarehouseLogList.aspx.cs"
    Inherits="Rapid.StoreroomManager.ProductWarehouseLogList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>半成品出入库主表</title>
    ...
    <script type="text/javascript">
        function Transfer(type, warehouseNumber) {

            //            if (type == "入库") {
            //                window.location.href = "HalfProductInWarehouseLogDetailList.aspx?WarehouseNumber=" + warehouseNumber;
            //            } else {

            //                window.location.href = "HalfProductOutWarehouseLogDetailList.aspx?WarehouseNumber=" + warehouseNumber;
            //            }
            window.location.href = "HalfProductWarehouseLogDetailList.aspx?WarehouseNumber=" + warehouseNumber + "&Type=" + encodeURI(type);
        }
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_HalfProductWarehouseLogList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "HalfProductWarehouseLogList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/HalfProductWarehouseLogList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                // OpenDialog("AddOrEditHalfProductWarehouseLog.aspx", "btnSearch", "350", "500");
                window.location.href = "AddHalfProduct.aspx";
            });
            //审核
            $("#btnCheck").click(function() {
                ...
                if (confirm("确定审核选择的数据?")) {
                    Check("../StoreroomManager/HalfProductWarehouseLogList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            ...
            $("#btnSearch").click();
            //绑定出入库编号
            //            BindSelect("HalfProductWarehouseLogWarehouseNumber", "WarehouseNumber");
            //绑定仓库名称
//            BindSelect("HalfProductWarehouseLogWarehouseName", "WarehouseName");
            //绑定变动方向
            BindSelect("HalfProductWarehouseLogChangeDirection", "ChangeDirection");
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库存管理&nbsp;&nbsp;>&nbsp;&nbsp;半成品出入库列表</span>
                                </td>
                                                ...
                                                <td colspan="5" style="text-align: left">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style="float: left; width: 65px;" id="divAdd" runat="server">
                                                            <input type="button" value="出库" id="btnAdd" class="button" />
                                                        </div>
                                                    ...
                                                    <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th sortname='制单时间'>
                                                                    制单时间<span><img src="../Img/bg.gif" id="Img8" /></span>
                                                                </th>
                                                                <th sortname='审核时间'>
                                                                    审核时间<span><img src="../Img/bg.gif" id="Img2" /></span>
                                                                </th>
                                                                <td>
                                                                    审核人
                                                                </td>
