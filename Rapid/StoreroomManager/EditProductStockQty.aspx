<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductStockQty.aspx.cs"
    Inherits="Rapid.StoreroomManager.EditProductStockQty" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
               <asp:TextBox runat="server" ID ="txtHW"></asp:TextBox>
            </td>
        </tr>
