<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T_ExaminationLog_KF.aspx.cs" Inherits="Rapid.StoreroomManager.T_ExaminationLog_KF" %>
...
<body>
    ...
    <div style="width: 100%; text-align: center; font: 96px; font-size:xx-large; font-weight: bold;
        margin-top: 20px">库房员工考试月度报表</div>
    <div>
