<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehousePerformanceReviewYearReport.aspx.cs" Inherits="Rapid.StoreroomManager.WarehousePerformanceReviewYearReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>库房员工绩效年度报表</title>
...
<body>
    ...
    <div style="width: 100%; text-align: center; font: 96px; font-size:xx-large; font-weight: bold;
        margin-top: 20px">库房员工绩效年度报表</div>
    <div>
