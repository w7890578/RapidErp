<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditScarpWarehouseLog.aspx.cs"
    Inherits="Rapid.StoreroomManager.AddOrEditScarpWarehouseLog" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>废品出入库信息维护</title>
      ...
      <%--  <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Label ID="Label7" runat="server" Text="（*号为必填项）" ForeColor="Red"></asp:Label>
            </td>
        </tr>
    </table>
