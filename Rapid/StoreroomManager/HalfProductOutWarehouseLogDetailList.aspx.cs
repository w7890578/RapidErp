...
{
    public partial class HalfProductOutWarehouseLogDetailList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    GetPage("AddOrEditHalfOutProductWarehouseLogDetail.aspx", "btnSearch", "350", "500");
                }
...
</td></tr>", dr[1], tdTextTemp, url, DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss"), btnId, height, width, hasEdit, dr["Guid"], dr["出库编号"]);
            }
