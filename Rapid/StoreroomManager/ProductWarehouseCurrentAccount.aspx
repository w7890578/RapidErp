<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductWarehouseCurrentAccount.aspx.cs"
    Inherits="Rapid.StoreroomManager.ProductWarehouseCurrentAccount" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>产成品库房流水帐</title>
    <!--通用基本样式-->
    ...
    <script type="text/javascript">
        function sysEdit(guid) {
            OpenDialog("SysEditMateialWarehouseCurrentAccount.aspx?guid=" + guid + "&isProduct=true", "btnSearch", "270", "520");
        }
        //排序字段
        var sortname = "移动时间";
        //排序规则
        ...
        function GetQueryCondition() {
            ...
            if (productnumber != '') {
                condition += " and 瑞普迪编号 like '%" + productnumber + "%'";
            }
        ...
        function ImpExecl() {
            querySql = " select * from V_ProductWarehouseCurrentAccount  ";
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            $.ajax({
                type: "Get",
                url: "ProductWarehouseCurrentAccount.aspx?time=" + new Date(),
...
<body>
    <form id="form1" runat="server">
        <div style="width: 1450px;">
            <input type="hidden" id="saveInfo" runat="server" /><asp:TextBox ID="txtSql" runat="server"
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="1101" background="../Img/tab_05.gif">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库房管理&nbsp;&nbsp;>&nbsp;&nbsp;产成品库房流水帐</span>
                                </td>
                                ...
                                <td bgcolor="#f3ffe3" style="padding-top: 5px;">
                                    <div>
                                        ...
                                        <table class="pg_table">
                                            <tr>
                                                <td>&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp; 客户产成品编号：<input type="text" id="txtCustomerProductNumber" />
                                                </td>
                                                <td>移动时间:
                                                <input type="text" id="txtMoveTime" />
                                                </td>
                                                <td>相关单号：<input type="text" id="txtOrdersNumber" />
                                                </td>
                                                <td>移动原因：<input type="text" id="txtMoveReason" />
                                                </td>
                                                <td>产成品编号：<input type="text" id="txtProductNumber" />
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="5" style="text-align: left">
                                                    ...
                                                    <div>
                                                        <div style="float: left; width: 285px;">
                                                            <input type="button" value="查询" id="btnSearch" class="button" style="margin-right: 10px;" />
                                                            <asp:Button ID="btnExcel" runat="server" Text="导出Excel" OnClientClick="return ImpExecl()"
                                                                CssClass="button" OnClick="btnExcel_Click" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td></td>
                                                        ...
                                                        <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th sortname='瑞普迪编号'>产成品编号<span><img src="../Img/bg.gif" id="sortImg" /></span>
                                                                    </th>
                                                                    <th sortname='客户产成品编号'>客户产成品编号<span><img src="../Img/bg.gif" id="Img8" /></span>
                                                                    </th>
                                                                    <th sortname='版本'>版本<span><img src="../Img/bg.gif" id="Img1" /></span>
                                                                    </th>
                                                                    <th sortname='移动时间'>移动时间<span><img src="../Img/bg.gif" id="Img3" /></span>
                                                                    </th>
                                                                    ...
                                                                    <th sortname='发出'>发出<span><img src="../Img/bg.gif" id="Img5" /></span>
                                                                    </th>
                                                                    <th sortname='结存'>结存<span><img src="../Img/bg.gif" id="Img7" /></span>
                                                                    </th>
                                                                    <th sortname='经手人'>经手人<span><img src="../Img/bg.gif" id="Img9" /></span>
                                                                    </th>
                                                                    <th sortname='移动原因'>移动原因<span><img src="../Img/bg.gif" id="Img11" /></span>
                                                                    </th>
                                                                    <td>备注
                                                                    </td>
                                                                    <td>操作
