<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehouseAndOtherPerformanceReviewStandard.aspx.cs"
    Inherits="Rapid.StoreroomManager.WarehouseAndOtherPerformanceReviewStandard" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            $.ajax({
                type: "Get",
                url: "WarehouseAndOtherPerformanceReviewStandard.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/WarehouseAndOtherPerformanceReviewStandard.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditWarehouseAndOtherPerformance.aspx", "btnSearch", "320", "600");
            });
...
<body>
    ...
    <div style="margin-top:10px;">
        ...
        <div id="progressBar" style="position: absolute; top: 40%; left: 50%; display: none;">
          ...
          <span class="STYLE4" style="font-size:14px">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;仓库管理&nbsp;&nbsp;>&nbsp;&nbsp;仓库及其他考核标准</span>
