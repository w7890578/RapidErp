<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehouseInfoList.aspx.cs"
    Inherits="Rapid.ProduceManager.WarehouseInfoList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Detail(number, type, warehouseName) {
            if (type == "产成品库" || type == "半成品库") {
                window.location.href = "ProductStockOrHalfProductStockDetail.aspx?number=" + number + "&warehouseName=" + warehouseName;
            }
            else {
                window.location.href = "WarehouseMarerialDeatilList.aspx?number=" + number + "&warehouseName=" + warehouseName;
            }
        }
    </script>
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../StoreroomManager/WarehouseInfoList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;库存管理&nbsp;&nbsp;>&nbsp;&nbsp;仓库信息列表</span>
                            </td>
                                    ...
                                    <table class="pg_table">
                                        ...
                                        <tr>
                                            <td colspan="10" style="text-align: left">
                                                <div style="float: left; width: 150; margin-left: 30%">
                                                    每页显示条数：
                                                ...
                                                <div>
                                                    ...
                                                    <div style="float: left; width: 95px;" id="div2" runat="server">
                                                        <a href="ImpQty.aspx" style="color: Blue;">导入库存数量</a></div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                    ...
                                                    <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th sortname='编号'"'>
                                                                    编号<span><img src="../Img/bg.gif" id="sortImg" /></span>
                                                                </th>
                                                                <th sortname='仓库名称'>
                                                                    仓库名称<span><img src="../Img/bg.gif" id="Img8" /></span>
                                                                </th>
                                                                <th sortname='位置'>
                                                                    位置<span><img src="../Img/bg.gif" id="Img1" /></span>
                                                                </th>
                                                                <th sortname='类型'>
