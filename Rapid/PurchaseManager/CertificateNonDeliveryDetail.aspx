<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateNonDeliveryDetail.aspx.cs"
    Inherits="Rapid.PurchaseManager.CertificateNonDeliveryDetail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>采购未交全明细表</title>
    <!--通用基本样式-->
    ...
    <div>
        <div id="divHeader" style="margin-top: 20px;">
            <div style="margin-bottom: 3px">
                ...
                <asp:Label ID="Label1" runat="server" Text="供应商物料编号：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtSupplierNumber" runat="server"></asp:TextBox>
                <asp:Label ID="Label3" runat="server" Text="预计交期：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="LeadDate" runat="server" onfocus="WdatePicker({skin:'green'})"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;
            </div>
            <div style="margin-bottom: 5px;">
                <asp:Label ID="Label5" runat="server" Text="供应商名称：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtName" runat="server"></asp:TextBox>
                <asp:Label ID="Label6" runat="server" Text="采购日期：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtDate" runat="server" onfocus="WdatePicker({skin:'green'})"></asp:TextBox>
                <asp:Label ID="Label4" runat="server" Text="描述：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtDescription" runat="server"></asp:TextBox>
                <asp:Label ID="Label7" runat="server" Text="运输号：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtNumber" runat="server"></asp:TextBox>
            </div>
            <div>
                <asp:Label ID="Label8" runat="server" Text="付款：" Style="margin-left: 20px;"></asp:Label>
                <asp:TextBox ID="txtPay" runat="server"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label9" runat="server" Text="备注：" Style="margin-left: 20px;"></asp:Label>
