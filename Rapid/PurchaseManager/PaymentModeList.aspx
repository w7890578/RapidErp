<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentModeList.aspx.cs"
    Inherits="Rapid.PurchaseManager.PaymentModeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function edit(Number) {
            OpenDialog("../PurchaseManager/AddOrEditPaymentMode.aspx?Id=" + Number, "btnSearch", "180", "350");
            //window.location.href = "../PurchaseManager/AddOrEditPaymentMode.aspx?Id=" + Number;
        }
        $(function() {
            $("#btnAdd").click(function() {
                OpenDialog("../PurchaseManager/AddOrEditPaymentMode.aspx", "btnSearch", "180", "350");
                //window.location.href = "../PurchaseManager/AddOrEditPaymentMode.aspx";
            });
        });
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif" style="padding: 5px;">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;采购管理&nbsp;&nbsp;>&nbsp;&nbsp;付款方式列表</span>
                            </td>
                        ...
                        <td bgcolor="#f3ffe3" style="padding-top: 5px;">
                            <div>
                                ...
                                <asp:Button runat="server" ID="btnSearch"
                                        Text="查询" CssClass="button" onclick="btnSearch_Click" Visible ="false" />
                                   <%-- <input type="button" value="增加" id="btnAdd" class="button" style="margin-left: 400px;" />--%>
                                                ...
                                                <table class="tablesorter" cellpadding="1" cellspacing="1" id="printTalbe" style="width: 500px">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="tdOperar_付款方式" style="width: 100px">
                                                                付款方式
                                                            </td>
