...
{
    public partial class CertificateOrdersNeedReport : System.Web.UI.Page
    {
        ...
        private string GetSql()
        {
            ...
            string sql = string.Format(@"select * from V_CertificateOrdersNeedReport {0}", conditon);
            return sql;
        }
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            ToolCode.Tool.ExpExcel(GetSql(), "采购需求报表");
        }
    }
}
