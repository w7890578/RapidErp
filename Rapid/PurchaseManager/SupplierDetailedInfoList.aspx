<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierDetailedInfoList.aspx.cs"
    Inherits="Rapid.PurchaseManager.SupplierDetailedInfoList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>供货商列表详情页</title>
...
<body >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <label id="lbSupplierId" runat="server">
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <label id="lbSupplierName" runat="server">
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <label id="lbPaymentdays" runat="server">
                </label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <label id="lbPercentageInAdvance" runat="server">
                </label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <label id="lbBankRowNumber" runat="server">
                </label>
            </td>
        </tr>
        <tr>
