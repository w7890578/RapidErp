...
<body>
    <form id="form1" runat="server">
        ...
        <table class="border_Header">
            ...
            <tr>
                ...
                <td></td>
                <td>合同号：<asp:Label ID="lblOrdersNumber" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="style1">卖方：<asp:Label ID="lblSupplierName" runat="server" Text=""></asp:Label>
                </td>
                <td></td>
                <td>买方 ：北京瑞普迪电子设备有限公司
                </td>
            ...
            <table class="border" cellpadding="1" cellspacing="1">
                <thead>
                    <tr>
                        ...
                        <td class="tdOperar_num">序号
                        </td>
                        <td class="tdOperar_MaterialNumber">原材料编号
                        </td>
                        <td class="tdOperar_MaterialName">型号
                        </td>
                        <td class="tdOperar_SupplierMaterialNumber">供应商物料编号
                        </td>
                        <td class="tdOperar_OrderQty">数量
                        </td>
                        <td class="tdOperar_NonDeliveryQty">未交货数量
                        </td>
                        <td class="tdOperar_DeliveryQty">已交货数量
                        </td>
                        <td class="tdOperar_UnitPrice">单价（未税）
                        </td>
                        <td class="tdOperar_UP">单价（含税）
                        </td>
                        <td class="tdOperar_SumPrice">总价（未税）
                        </td>
                        <td class="tdOperar_SP">总价（含税）
                        </td>
                        <td class="tdOperar_MinOrderQty">最小起订量
                        </td>
                        <td class="tdOperar_LeadTime">交期
                        </td>
                        <td class="tdOperar_PayOne" style="display: <%=showPay%>;">付款一
                        </td>
                        <td class="tdOperar_PayTwo" style="display: <%=showPay%>;">付款二
                        </td>
                        <td class="tdOperar_Status">状态
                        </td>
                ...
                <tbody>
                    ...
                    <%if (!string.IsNullOrEmpty(CCTCOrdersNumber))
                      {%>
                    <tr>
                        <td colspan="16">采购退料出库单：<%=CCTCOrdersNumber %></td>
                    </tr>
                    <%  } %>
                </tbody>
            </table>
        ...
        <table class="border_Header">
            ...
            <tr>
                <td>2.技术标准：按制造商产品的技术执行，如有质量问题，供方负责换货
                </td>
            </tr>
            <tr>
                <td>3.含运费：运至客户指定地点
            ...
            <tr>
                <td>6.付款方式：<asp:Label ID="lbPayMode" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>7.合同传真件有效
    ...
    <table class="border_Header">
        <tr>
            <td>单位名称：<asp:Label ID="lblSupplieId" runat="server" Text=""></asp:Label>
            </td>
            <td>&nbsp;
            </td>
        ...
        <tr>
            <td>单位地址：<asp:Label ID="lblFactoryAddress" runat="server" Text=""></asp:Label>
            </td>
            <td>&nbsp;
            </td>
            <td>单位地址：北京市顺义区顺强路1号嘉德工厂3号楼3层
            </td>
        </tr>
        <tr>
            <td>联系电话：<asp:Label ID="lblContactTelephone" runat="server" Text=""></asp:Label>
            </td>
            <td>&nbsp;
            </td>
            <td>联系电话：010-000010101
            </td>
        </tr>
        <tr>
            <td>邮箱：<asp:Label ID="lblEmail" runat="server" Text=""></asp:Label>
            </td>
            <td>&nbsp;
            </td>
            <td>传真：010-8898888
        ...
        <tr>
            <td>联系人：<asp:Label ID="lblContacts" runat="server" Text=""></asp:Label>
            </td>
            <td>&nbsp;
            </td>
            <td>联系人：<asp:Label ID="lblContactName" runat="server" Text=""></asp:Label>
            </td>
        </tr>
    </table>
    </form>
