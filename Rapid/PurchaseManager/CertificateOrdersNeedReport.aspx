<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateOrdersNeedReport.aspx.cs"
    Inherits="Rapid.PurchaseManager.CertificateOrdersNeedReport" %>
        ...
        <table class="border" cellpadding="1" cellspacing="1" id="mainTable">
            <thead>
                <tr>
                    ...
                    <td class="tdOperar_订单数量">
                        订单数量
                    </td>
                    <td class="tdOperar_ 计算结果">
                        计算结果
                    </td>
                    <td class="tdOperar_仓位">
                        仓位
                    </td>
                    <td class="tdOperar_安全用量">
                        安全用量
                    </td>
                    <td class="tdOperar_在途数量">
                        在途数量
                    </td>
                    ...
                    <td class="tdOperar_收款账户">
                        收款账户
                    </td>
                    <td class="tdOperar_收款银行">
                        收款银行
                    </td>
                </tr>
            </thead>
