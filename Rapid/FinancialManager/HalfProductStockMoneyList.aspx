<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HalfProductStockMoneyList.aspx.cs"
    Inherits="Rapid.FinancialManager.HalfProductStockMoneyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>半成品库存金额报表</title>
                    ...
                    <div>
                        ...
                        <div id="divHeader">
                            <div style="background-image: url(../Img/nav_tab1.gif); width: auto; margin-bottom: 10px">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;账务管理&nbsp;&nbsp;>&nbsp;&nbsp;半产品库存金额报表</span>
                            </div>
                            <div style="position: relative; float: left; margin-bottom: 10px; top: 0px; left: 0px;">
                                ...
                                <input type="button" value="打印" id="btnPrint" style="margin-left: 10px; margin-right: 10px;"
                                    class="button" />
                                <asp:Button ID="btnEmp" runat="server" Text="导出Excel" class="button" OnClick="btnEmp_Click" />
