<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPrepaidAdvanceCheck.aspx.cs" Inherits="Rapid.FinancialManager.EditPrepaidAdvanceCheck" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpIsSettle" runat="server">
