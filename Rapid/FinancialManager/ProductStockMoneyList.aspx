<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductStockMoneyList.aspx.cs"
    Inherits="Rapid.FinancialManager.ProductStockMoneyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>产成库存总金额表</title>
                        ...
                        <div>
                            ...
                            <div id="divHeader">
                                <div style="background-image: url(../Img/nav_tab1.gif); width: auto; margin-bottom: 10px">
                                    ...
                                    <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;账务管理&nbsp;&nbsp;>&nbsp;&nbsp;产成品库存总金额表</span>
                                </div>
                                ...
                                <asp:Label ID="Label1" runat="server" Text="产成品编号："></asp:Label>
                                    ...
                                    <span id="spPrint" runat="server">
                                        <input type="button" value="打印" id="btnPrint" style="margin-left: 10px; margin-right: 10px;" class="button" /></span>
