<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_ProductWarehouseCurrentAccount.aspx.cs" Inherits="Rapid.FinancialManager.Report_ProductWarehouseCurrentAccount" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产成品库房流水账金额统计表</title>
    ...
    <script type="text/javascript">
        ...
        function GetQueryCondition() {
            ...
            var txtCustomerProductNumber = $.trim($("#txtCustomerProductNumber").val());
            if (txtMoveReason != "") {
            ...
            if (txtCustomerProductNumber != "")
            {
                condition += " and  客户产成品编号  like '%" + txtCustomerProductNumber + "%' ";
            }
            return condition;
        }
        //导出Execl前将查询条件内容写入隐藏标签
        function ImpExecl() {
            querySql = "select * from V_Report_ProductWarehouseCurrentAccount   ";
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            $.ajax({
                type: "Get",
                url: "Report_ProductWarehouseCurrentAccount.aspx",
                    ...
                    <td colspan="11">
                        <div id="divs">
                            <div style="background-image: url(../Img/nav_tab1.gif); width: auto; margin-bottom: 10px;">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;财务管理&nbsp;&nbsp;>&nbsp;&nbsp;产成品库房流水账金额统计表</span>
                            </div>
                            <div style="vertical-align: middle">
                                <div style="float: left; width: 150;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;客户产成品编号：
                                     <input type="text" id="txtCustomerProductNumber" style="margin-right: 10px" />
                                    &nbsp;&nbsp;移动原因：
                    ...
                    <td colspan="10">
                        <div>
                            <table class="tablesorter" cellpadding="1" cellspacing="1" id="printTalbe">
                                <thead>
                                    <tr>
                                        <th sortname='瑞普迪编号'>产成品编号<span><img src="../Img/bg.gif" id="Img1" /></span>
                                        </th>
                                        <th sortname='客户产成品编号'>客户产成品编号<span><img src="../Img/bg.gif" id="Img1" /></span>
                                        </th>
