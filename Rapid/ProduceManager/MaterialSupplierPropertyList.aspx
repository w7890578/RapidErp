<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialSupplierPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.MaterialSupplierPropertyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>原材料供应商属性列表</title>
    <!--通用基本样式-->
    ...
    <script type="text/javascript">
        ...
        var querySql = "";
        //原材料编号
        var MaterialNumber = getQueryString("Id");

        //获取查询条件
        function GetQueryCondition() {
            var condition = " where 原材料编号='" + MaterialNumber + "'";
            return condition;
        }
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_MaterialSupplierPropertyList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "MaterialSupplierPropertyList.aspx",
                data: { time: new Date(), Id: MaterialNumber, pageIndex: pageIndex, pageSize: pageSize, sortName: sortName, sortDirection: sortDirection, querySql: querySql },
        ...
        $(document).ready(function () {
            ...
            $("#btnDelete").click(function () {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteDataProperty("../ProduceManager/MaterialSupplierPropertyList.aspx", MaterialNumber, ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function () {
                OpenDialog("AddOrEditMaterialSupplierProperty.aspx?MaterialNumber=" + MaterialNumber, "btnSearch", "350", "600");
            });
                        ...
                        <td colspan="5" style="text-align: left">
                            <div style="vertical-align: middle">
                                <div style="float: left; width: 150;">
                                    每页显示条数：<input onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
                            ...
                            <div>
                                ...
                                <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "SuppliersAdd"))
                                   {  %>
                                <div style="float: left; width: 65px;" id="divAdd" runat="server">
                                    <input type="button" value="增加" id="btnAdd" class="button" />
                                </div>
                                <%} %>
                                <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "SuppliersDelete"))
                                   {  %>
                                ...
                                <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th sortname='供应商物料编号'>供应商物料编号<span><img src="../Img/bg.gif" id="Img8" /></span>
                                            </th>
                                            <th sortname='供应商名称'>供应商名称<span><img src="../Img/bg.gif" id="Img1" /></span>
                                            </th>
                                            <th sortname='最小起订量'>最小起订量<span><img src="../Img/bg.gif" id="Img4" /></span>
                                            </th>
                                            <th sortname='单价'>单价<span><img src="../Img/bg.gif" id="Img2" /></span>
                                            </th>
                                            <th sortname='供应商交货周期'>供应商交货周期<span><img src="../Img/bg.gif" id="Img3" /></span>
                                            </th>
                                            <td>备注
                                            </td>
                                            <td>操作
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="9" align="center">暂无数据
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td colspan="9" style="background-color: #F3FFE3; padding-top: 10px; padding-left: 10px; padding-right: 10px;">
