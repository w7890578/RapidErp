<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MareriaTypeList.aspx.cs"
    Inherits="Rapid.ProduceManager.MareriaTypeList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function edit(id) {
            OpenDialog("../ProduceManager/AddOrEditMareriaType.aspx?Type=" + encodeURI(id), "btnSearch", "180", "350");
        }
        function Delete(id) {
            if (confirm("确定删除？")) {
                $.ajax({
                    type: "Get",
                    url: "MareriaTypeList.aspx",
        ...
        $(function() {
            $("#btnAdd").click(function() {
                OpenDialog("../ProduceManager/AddOrEditMareriaType.aspx", "btnSearch", "180", "300");
            });
        });
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif" style="padding: 5px;">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;原材料类别列表</span>
                            </td>
                                                ...
                                                <table class="tablesorter" cellpadding="1" cellspacing="1" id="printTalbe" style="width: 500px">
                                                    ...
                                                    <tbody>
                                                        <asp:Repeater runat="server" ID="rpList">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td class="ttdOperar_原材料类别">
                                                                        <%#Eval("原材料类别")%>
                                                                    </td>
                                                                    <td class="tdOperar">
                                                                        <a href="###" onclick="edit('<%#Eval("原材料类别") %>')">编辑</a></span>
                                                                        <%-- <span style="display:<%=hasDelete%>;"> <a href="###" onclick="Delete('<%#Eval("id") %>')">
                                                                            删除</a></span>--%>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
