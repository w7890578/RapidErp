                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif" style="padding: 5px;">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;基础工序列表</span>
                            </td>
                                                ...
                                                <table class="tablesorter" cellpadding="1" cellspacing="1" id="printTalbe" style="width: 800px">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <td class="tdOperar_工序编号" style="width: 100px">
                                                                工序编号
                                                            </td>
                                                            <td class="tdOperar_工序名称" style="width: 100px">
                                                                工序名称
                                                            </td>
                                                        ...
                                                        <asp:Repeater runat="server" ID="rpList">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td class="ttdOperar_工序编号">
                                                                        <%#Eval("工序编号")%>
                                                                    </td>
                                                                    <td class="ttdOperar_工序名称">
                                                                        <%#Eval("工序名称")%>
                                                                    </td>
                                                                    <td class="tdOperar">
                                                                        <span style="display: <%=hasEdit%>;"><a href="###" onclick="edit('<%#Eval("工序编号") %>')">
                                                                            编辑</a> </span>
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
