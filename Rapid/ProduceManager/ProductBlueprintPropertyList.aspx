<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductBlueprintPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.ProductBlueprintPropertyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产品图纸属性列表</title>
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ProductBlueprintPropertyList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "ProductBlueprintPropertyList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteProductProperty("../ProduceManager/ProductBlueprintPropertyList.aspx", ProductNumber, Version, ConvertsContent(checkResult), "btnSearch");
            ...
            $("#btnAdd").click(function() {
                OpenDialog("AddOrEditProductBlueprintProperty.aspx?ProductNumber=" + ProductNumber + "&Version=" + Version, "btnSearch", "380", "600");
                    ...
                    <div>
                        <table class="tablesorter" cellpadding="1" cellspacing="1">
                            <thead>
                                <tr>
                                    <td>
                                        <label style="width: 100px; display: block; cursor: pointer;">
                                            <input type="checkbox" />全选/反选</label>
                                    </td>
                                    <th sortname='产成品编号' style="width: 150px;">
                                    ...
                                    <th sortname='修改时间' style="width: 100px;">
                                        修改时间<span><img src="../Img/bg.gif" id="Img1" /></span>
                                    </th>
                                    <td style="width: 150px;">
                                        要求修改人
                                    </td>
                                    <th sortname='导入时间' style="width: 100px;">
                                        导入时间<span><img src="../Img/bg.gif" id="Img2" /></span>
                                    </th>
                                    ...
                                    <th sortname='发放日期' style="width: 150px;">
                                        发放日期<span><img src="../Img/bg.gif" id="Img4" /></span>
                                    </th>
                                    <td style="width: 100px;">
                                        接收人员
                                    </td>
