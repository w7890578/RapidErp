<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialBlueprintPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.MaterialBlueprintPropertyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>原材料图纸属性列表</title>
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_MaterialBlueprintPropertyList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "MaterialBlueprintPropertyList.aspx",
                ...
                success: function (result) {
                    ...
                    if (result != "") {
                        ...
                        if (tempArray[1] == "") {
                            //如果没有数据
                            var tempStr = " <tr> <td colspan='8' align='center'>  查无数据 </td> </tr>";
        ...
        $(document).ready(function () {
            ...
            $("#btnDelete").click(function () {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteDataProperty("../ProduceManager/MaterialBlueprintPropertyList.aspx", MaterialNumber, ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function () {
                ...
                OpenDialog("AddOrEditMaterialBlueprintProperty.aspx?MaterialNumber=" + MaterialNumber, "btnSearch", "260", "600");
            });
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="text-align: left">
                            ...
                            <div>
                                ...
                                <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "DrawingAdd"))
                                   {  %>
                                <div style="float: left; width: 65px;" id="divAdd" runat="server">
                                    <input type="button" value="增加" id="btnAdd" class="button" />
                                </div>
                                <%} %>
                                <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "DrawingDelete"))
                                   {  %>
                                ...
                                <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th sortname='修改时间'>修改时间<span><img src="../Img/bg.gif" id="Img1" /></span>
                                            </th>
                                            <th sortname='导入时间'>导入时间<span><img src="../Img/bg.gif" id="Img2" /></span>
                                            </th>
                                            <td style="display: none;">上传路径
                                            </td>
                                            <td>导入人员
                                            </td>
                                            <td>备注
