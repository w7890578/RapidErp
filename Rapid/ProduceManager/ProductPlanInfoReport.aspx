...
<body>
    <form id="form1" runat="server">
        <div class="outerDiv" style="width: 2600px; margin-right: 20px;">
            ...
            <div style="background-image: url(../Img/nav_tab1.gif); width: auto; margin-top: 1px; padding-top: 4px;">
            ...
            <div>
                ...
                <table class="pg_table" style="margin-top: 10px">
                    ...
                    <tr>
                        <td>&nbsp&nbsp; &nbsp&nbsp; &nbsp&nbsp; &nbsp&nbsp; 客户产成品编号：
                    ...
                    <tr>
                        <td>&nbsp&nbsp; &nbsp&nbsp; &nbsp&nbsp; &nbsp&nbsp; 客户采购订单号：
                                ...
                                <table class="tablesorter" cellpadding="1" cellspacing="1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th sortname='客户产成品编号'>客户产成品编号<span><img src="../Img/bg.gif" id="Img25" /></span>
                                            </th>
                                            <th sortname='产成品编号'>产成品编号<span><img src="../Img/bg.gif" id="Img26" /></span>
                                            </th>
                                            <th sortname='版本'>版本<span><img src="../Img/bg.gif" id="Img27" /></span>
                                            </th>
                                            <th sortname='套数'>套数<span><img src="../Img/bg.gif" id="Img28" /></span>
                                            </th>
                                            <th sortname='开工单号'>开工单号<span><img src="../Img/bg.gif" id="Img29" /></span>
                                            </th>
                                            <th sortname='开工单类型'>开工单类型<span><img src="../Img/bg.gif" id="Img30" /></span>
                                            </th>
                                            <th sortname='开工单实际开始时间'>开工单实际开始时间<span><img src="../Img/bg.gif" id="Img31" /></span>
                                            </th>
                                            <th sortname='开工单实际结束时间'>开工单实际结束时间<span><img src="../Img/bg.gif" id="Img32" /></span>
                                            </th>
                                            <th sortname='班组'>班组<span><img src="../Img/bg.gif" id="Img33" /></span>
                                            </th>
                                            <th sortname='小组实际开始时间'>小组实际开始时间<span><img src="../Img/bg.gif" id="Img34" /></span>
                                            </th>
                                            <th>小组结束时间
                                            </th>
                                            <th sortname='销售订单号'>销售订单号<span><img src="../Img/bg.gif" id="Img36" /></span>
                                            </th>
                                            <th sortname='订单类型'>订单类型<span><img src="../Img/bg.gif" id="Img4" /></span>
                                            </th>
                                            <th sortname='行号'>行号<span><img src="../Img/bg.gif" id="Img37" /></span>
                                            </th>
                                            <th sortname='单套工时'>单套工时<span><img src="../Img/bg.gif" id="Img38" /></span>
                                            </th>
                                            <th sortname='合计工时'>合计工时<span><img src="../Img/bg.gif" id="Img39" /></span>
                                            </th>
                                            <th>工序1(工时)
                                            </th>
                                            <th>工序2(工时)
                                            ...
                                            <th sortname='交接班组'>交接班组<span><img src="../Img/bg.gif" id="Img44" /></span>
                                            </th>
                                            <th sortname='完成数量'>完成数量<span><img src="../Img/bg.gif" id="Img45" /></span>
                                            </th>
                                            <%--   <th sortname='交线情况'>
                                            交线情况<span><img src="../Img/bg.gif" id="Img46" /></span>
                                        </th>--%>
                                            <th sortname='交期时间'>交期时间<span><img src="../Img/bg.gif" id="Img47" /></span>
                                            </th>
                                            <th sortname='创建时间'>创建时间<span><img src="../Img/bg.gif" id="Img1" /></span>
                                            </th>
                                            <th sortname='客户采购订单号'>客户采购订单号<span><img src="../Img/bg.gif" id="Img2" /></span>
                                            </th>
                                            <th sortname='完成情况'>完成情况<span><img src="../Img/bg.gif" id="Img3" /></span>
                                            </th>
                                            <td>备注
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="29" align="center">暂无数据
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <td colspan="29" style="background-color: #F3FFE3; padding-top: 10px; padding-left: 10px; padding-right: 10px;">
