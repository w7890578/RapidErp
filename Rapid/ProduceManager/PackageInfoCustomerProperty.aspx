<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackageInfoCustomerProperty.aspx.cs"
    Inherits="Rapid.ProduceManager.PackageInfoCustomerProperty" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        var querySql = "";
        //原材料编号
        var PackageNumber = getQueryString("id");
        //获取查询条件
        function GetQueryCondition() {
            var condition = " where 包编码='" + PackageNumber + "' ";
            return condition;
        }
        //获取数据
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_PackageInfoCustomerProperty ";
            querySql = querySql + " " + GetQueryCondition();
           
            $.ajax({
                type: "Get",
                url: "PackageInfoCustomerProperty.aspx",
                data: { time: new Date(), id: PackageNumber, pageIndex: pageIndex, pageSize: pageSize, sortName: sortName, sortDirection: sortDirection, querySql: querySql },
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteDataProperty("../ProduceManager/PackageInfoCustomerProperty.aspx", PackageNumber, ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditPackageInfoCustomerProperty.aspx?PackageNumber=" + PackageNumber, "btnSearch", "260", "600");
                            ...
                            <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                <thead>
                                    <tr>
                                        ...
                                        <th sortname='包编码'>
                                            包编码<span><img src="../Img/bg.gif" id="sortImg" /></span>
                                        </th>
                                       
                                         <th sortname='公司名称'>
                                            公司名称<span><img src="../Img/bg.gif" id="Img1" /></span>
                                        </th>
                                        <th sortname='包客户编号'>
                                            包客户编号<span><img src="../Img/bg.gif" id="Img2" /></span>
                                        </th>
                                        <td>
                                            备注
                                        </td>
