<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PackageInfoList.aspx.cs"
    Inherits="Rapid.ProduceManager.PackageInfoList" %>
...
<head runat="server">
 ...
 <script type="text/javascript">
     $(function() {
         ...
         var result = $("#hdPackageNumber").val(); //选中的包编码
             ...
             if (title == "包客户属性") {
                 ...
                 $("#baokehushuxing").show().html("<iframe style='position: relative; background-color: transparent;' width='100%' height='500' frameborder='0' src='PackageInfoCustomerProperty.aspx?id=" + result + "' </iframe>");
             }
             else {
                 $("#baoxinxi").show();
             }
    ...
    <script type="text/javascript">
        ...
        function GetQueryCondition() {
            ...
            var PackageNumber = $("#PackageNumber").find("option:selected").text();


            var packageName = $("#PackageName").val();
            var PackageName = $("#PackageName").find("option:selected").text();

            if (packageNumber != "" && packageNumber != null) {
                condition += " and 包编码='" + PackageNumber + "' ";
            }
            if (packageName != "" && packageName != null) {
                condition += " and 名称='" + PackageName + "' ";
            }
            return condition;
        }
        //获取数据
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_PackageInfoList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "PackageInfoList.aspx",
                ...
                success: function(result) {
                    ...
                    if (result != "") {
                        ...
                        $(".tablesorter tbody tr").click(function() {
                            ...
                            //选项卡用到的
                            $("#hdPackageNumber").val($(this).find("td:eq(2)").html());
                            $("#lbPackageNumber").html($(this).find("td:eq(2)").html());
                        });
                        ...
                        if (tempArray[1] == "") {
                            //如果没有数据
                            var tempStr = " <tr> <td colspan='6' align='center'>  查无数据 </td> </tr>";
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../ProduceManager/PackageInfoList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditPackageInfo.aspx", "btnSearch", "200", "600");
            });
            ...
            $("#btnSearch").click();
            //绑定包编码
            BindSelect("PackageNumber", "PackageNumber");
            //绑定包名称
            BindSelect("PackageName", "PackageName");
...
<body>
    ...
    <div style="width: 1500px">
        ...
        <div style="margin-top: 5px; text-align: center;">
           包编码:<label id="lbPackageNumber" style="color: Green;"></label></div>
        <div style="padding-right: 10px;">
            <div id="tab">
                <ul id="menus-tab">
                    <li class="on">包信息列表</li>
                    <li>包客户属性</li>
                </ul>
                <div id="content">
                    <div class="show" id="baoxinxi">
                                                    ...
                                                    <table class="tablesorter" cellpadding="1" cellspacing="1">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th sortname='包编码'>
                                                                    包编码<span><img src="../Img/bg.gif" id="Img8" /></span>
                                                                </th>
                                                                <th sortname='名称'>
                                                                    名称<span><img src="../Img/bg.gif" id="Img1" /></span>
                                                                </th>
                                                                <td>
                                                                    备注
                                                                </td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <td colspan="6" style="background-color: #F3FFE3; padding-top: 10px; padding-left: 10px;
                                                                    padding-right: 10px;">
                    ...
                    <div id="baokehushuxing" style="display: none;">
                      包客户属性
                    </div>
                </div>
            </div>
