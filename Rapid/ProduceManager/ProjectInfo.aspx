<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectInfo.aspx.cs" Inherits="Rapid.ProduceManager.ProjectInfo" %>
...
<head id="Head1" runat="server">
    ...
    $(function() {
            $("#btnAdd").click(function() {
                    OpenDialog("AddOrEditProjectInfo.aspx?ProjectNumber=<%=projectnumber %>", "btnSearch", "300", "600");
            });
        $(function() {
            $("#menus-tab li").click(function() {
                ...
                if (title == "项目包属性") {
                    $("#ProjectInfo").hide();
                    $("#ProjectProductProperty").hide();
                    $("#ProjectPackageProperty").show().html("<iframe style='position: relative; background-color: transparent;' width='100%' height='100%' frameborder='0' src='ProjectPackageProperty.aspx?ProjectNumber=<%=projectnumber %>'></iframe>");
                    //$("#yclsunhaomingxi").show().html("点击选项呀");
                }
                else if (title == "项目产品属性") {
                    $("#ProjectInfo").hide();
                    $("#ProjectPackageProperty").hide();
                    $("#ProjectProductProperty").show().html("<iframe style='position: relative; background-color: transparent;' width='100%' height='100%' frameborder='0' src='ProjectProductProperty.aspx?ProjectNumber=<%=projectnumber %>'></iframe>");
                }
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="1101" background="../Img/tab_05.gif" style="padding: 5px;">
                            ...
                            <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;项目信息列表</span>
                        </td>
                                                    ...
                                                    <div style="padding-right: 10px;">
                                                        ...
                                                        <div id="tab">
                                                            ...
                                                            <div id="content">
                                                                ...
                                                                <div id="ProjectPackageProperty" style="display: none;">
                                                                    项目包属性
                                                                </div>
                                                                <div id="ProjectProductProperty" style="display: none;">
                                                                    项目产品属性
                                                                </div>
                                                            </div>
                                                        </div>
