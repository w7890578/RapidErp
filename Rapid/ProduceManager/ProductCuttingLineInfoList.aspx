<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCuttingLineInfoList.aspx.cs"
    Inherits="Rapid.ProduceManager.ProductCuttingLineInfoList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //获取产成品原材料编号
        var MaterialNumber = getQueryString("MaterialNumber");

        //获取查询条件
        function GetQueryCondition() {
            var condition = " where  产成品编号='" + ProductNumber + "' and 版本='" + Version + "' and 原材料编号='" + MaterialNumber + "'";
            return condition;
        }
        //获取数据
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ProductCuttingLineInfoList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "ProductCuttingLineInfoList.aspx",
                data: { time: new Date(), ProductNumber: ProductNumber, Version: Version, MaterialNumber: MaterialNumber, pageIndex: pageIndex, pageSize: pageSize, sortName: sortName, sortDirection: sortDirection, querySql: querySql },
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteProductCuttingLineInfo("../ProduceManager/ProductCuttingLineInfoList.aspx", ProductNumber, Version, MaterialNumber, ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditProductCuttingLineInfo.aspx?ProductNumber=" + ProductNumber + "&Version=" + Version + "&MaterialNumber=" + MaterialNumber, "btnSearch", "320", "600");
                            ...
                            <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                <thead>
                                    <tr>
                                        ...
                                        <th sortname='长度'>
                                            长度<span><img src="../Img/bg.gif" id="Img2" /></span>
                                        </th>
                                        <th sortname='数量' style ="display :none ;">
                                            数量<span><img src="../Img/bg.gif" id="Img4" /></span>
                                        </th>
                                        <td>
                                            备注
                                        </td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="9" style="background-color: #F3FFE3; padding-top: 10px; padding-left: 10px;
                                            padding-right: 10px;">
