<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialCustomerPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.MaterialCustomerPropertyList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_MaterialCustomerPropertyList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "MaterialCustomerPropertyList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteDataProperty("../ProduceManager/MaterialCustomerPropertyList.aspx", MaterialNumber, ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                OpenDialog("AddOrEditMaterialCustomerProperty.aspx?MaterialNumber=" + MaterialNumber, "btnSearch", "260", "600");
                    ...
                    <td colspan="5" style="text-align: left">
                        ...
                        <div>
                            <div style="float: left; width: 65px;">
                              ...
                              <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "CustomerAdd"))
                                   {  %>
                            <div style="float: left; width: 65px;" id="divAdd" runat="server">
                                <input type="button" value="增加" id="btnAdd" class="button" />
                            </div>
                            <%} %>
                              <% if (Rapid.ToolCode.Tool.GetUserMenuFunc("L0112", "CustomerDelete"))
                                   {  %>
