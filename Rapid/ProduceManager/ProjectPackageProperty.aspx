<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectPackageProperty.aspx.cs"
    Inherits="Rapid.ProduceManager.ProjectPackageProperty" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
     function Delete(projectnumber) {
            if (confirm("确定删除？")) {
                $.ajax({
                    type: "Get",
                    url: "ProjectPackageProperty.aspx",
    ...
    $(function() {
            $("#btnAdd").click(function() {
                    OpenDialog("AddOrEditProjectPackageProperty.aspx?ProjectNumber=<%=projectnumber %>", "btnSearch", "300", "600");
                    }
                   });
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="1101" background="../Img/tab_05.gif" style="padding: 5px;">
                            ...
                            <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;项目信息列表&nbsp;&nbsp;>项目包属性</span>
                        </td>
