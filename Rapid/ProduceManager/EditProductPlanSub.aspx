<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductPlanSub.aspx.cs"
    Inherits="Rapid.ProduceManager.EditProductPlanSub" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFactStartTime" runat="server" CssClass="input required" size="25"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFactEndTime" runat="server" CssClass="input required" size="25"
                    onfocus="WdatePicker({skin:'green',dateFmt:'yyyy-MM-dd HH:mm:ss'})"></asp:TextBox>
            </td>
        </tr>
        <tr>
