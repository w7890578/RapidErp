<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductCustomerPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.ProductCustomerPropertyList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>产品客户属性列表</title>
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ProductCustomerPropertyList ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "ProductCustomerPropertyList.aspx",
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteProductProperty("../ProduceManager/ProductCustomerPropertyList.aspx",escape( ProductNumber), escape( Version), ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditProductCustomerProperty.aspx?ProductNumber=" + escape( ProductNumber) + "&Version=" +escape( Version), "btnSearch", "260", "600");
            ...
            <tr>
                ...
                <td colspan="5" style="text-align: left">
                    ...
                    <div>
                       ...
                       <%-- display :<%=(Session["User_Func"] as System.Collections.Generic.List<string>).Contains("L0113|C_Add")?"inline": "none"%>;--%>
                        <div style="float: left; width: 65px;" id="divAdd" runat="server">
                            <input type="button" value="增加" id="btnAdd" class="button" /> 
                        </div>
                        <%--display :<%=(Session["User_Func"] as System.Collections.Generic.List<string>).Contains("L0113|C_Delete")?"inline": "none"%>;--%>
                        ...
                        <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                            <thead>
                                <tr>
                                    ...
                                    <th sortname='客户产成品编号'>
                                        客户产成品编号<span><img src="../Img/bg.gif" id="Img1" /></span>
                                    </th>
                                    <th sortname='客户名称'>
