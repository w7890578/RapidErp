<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditAvailableTwineTable.aspx.cs"
    Inherits="Rapid.ProduceManager.AddOrEditAvailableTwineTable" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>可利用废线信息维护</title>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCustomerMaterialNumber" runat="server" CssClass="input" size="25"></asp:TextBox>
                <asp:Label ID="lblCustomerMaterialNumber" runat="server" Text=""></asp:Label>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtLength" runat="server" CssClass="input" size="25"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescription" runat="server" CssClass="input" size="25"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right">
