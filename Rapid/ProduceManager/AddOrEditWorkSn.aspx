<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrEditWorkSn.aspx.cs"
    Inherits="Rapid.ProduceManager.AddOrEditWorkSn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>基础工序信息维护</title>
...
<body >
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr  runat="server">
            ...
            <td>
                <asp:TextBox ID="txtWorkSnNumber" runat="server" CssClass="input required" size="25"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtWorkSnName" runat="server" CssClass="input required" size="25" ></asp:TextBox>
