<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExaminationLogList.aspx.cs"
    Inherits="Rapid.ProduceManager.ExaminationLogList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>员工考试成绩上报列表</title>
    <!--通用基本样式-->
    ...
    <script type="text/javascript">
        function Edit(year, month, name) {
            //alert(year + " " + month + " " + name);
            OpenDialog("../ProduceManager/EditExaminationLogList.aspx?year=" + year + "&month=" + month + "&name=" + encodeURI(name), "btnSearch", "300", "600")
        }
        $(function () {
            $("#btnZJ").click(function () {
                OpenDialog("../ProduceManager/AddExaminationLogListForUser.aspx", "btnSearch", "300", "600");
            });
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ExaminationLog_New ";
            querySql = querySql + " " + GetQueryCondition();

            $.ajax({
                type: "Get",
                url: "ExaminationLogList.aspx?time=" + new Date(),
        ...
        $(document).ready(function() {
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteData("../ProduceManager/ExaminationLogList.aspx", ConvertsContent(checkResult), "btnSearch");
                }
            });
            //绑定排序事件和样式
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditExaminationLog.aspx", "btnSearch", "520", "550");
            });
            ...
            $("#btnImp").click(function() {
                OpenDialog("ImpExaminationLog.aspx", "btnSearch", "320", "500");
            });
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif">
                                ...
                                <span class="STYLE4">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;员工考试成绩上报列表</span>
                            </td>
                                                ...
                                                <div>
                                                    ...
                                                    <div style="float: left; width: 65px;" id="divImp" runat="server">
                                                     ...
                                                     <div style="float: left; width: 65px;" id="div1" runat="server">
                                                        <input type="button" value="追加上报" id="btnZJ" class="button" />
                                                    </div>
                                                    <div style="float: left; width: 65px;">
