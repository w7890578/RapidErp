<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairReceiptList.aspx.cs" Inherits="Rapid.ProduceManager.RepairReceiptList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Transfer(warehousenumber, Type) {
            window.location.href = "../StoreroomManager/ToolMaterialWarehouseLogDetail.aspx?WarehouseNumber=" + warehousenumber + "&Type=" + encodeURI(Type) + "&IsRepairReceiptList=true";
        }
        //确认
        function Determine(warehousenumber) {
            ...
            $.get("RepairReceiptList.aspx?sq=" + new Date(), { IsDetermine: "true", Warehousenumber: warehousenumber }, function(result) {
                if (result == "1") {
                    alert("确认成功");
                    $("#btnSearch").click();
                    return;
        ...
        function Delete(warehousenumber) {
            ...
            $.get("RepairReceiptList.aspx?sq=" + new Date(), { IsDelete: "true", Warehousenumber: warehousenumber }, function(result) {
                if (result == "1") {
                    alert("删除成功");
                    $("#btnSearch").click();
                    return;
...
//            OpenDialog("../StoreroomManager/AddOrEditMarerialWarehouseLog.aspx?IsRepairReceiptList=true", "btnSearch", "240", "600");
//            });
        })
    </script>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="1101" background="../Img/tab_05.gif">
                                ...
                                <span class="STYLE4" id="navHead">&nbsp;&nbsp;首页&nbsp;&nbsp;>&nbsp;&nbsp;生产管理&nbsp;&nbsp;>&nbsp;&nbsp;维修出库</span>
                            </td>
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <span style="display: <%#Eval("是否确认").ToString ().Equals ("是")?"none":"inline"%>;">
                                                                                &nbsp;&nbsp; <a href="###" onclick="Delete('<%#Eval("出入库编号")%>')">删除</a> &nbsp;&nbsp;
