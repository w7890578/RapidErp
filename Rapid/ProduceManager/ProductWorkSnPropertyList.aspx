<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductWorkSnPropertyList.aspx.cs"
    Inherits="Rapid.ProduceManager.ProductWorkSnPropertyList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            querySql = " select * from V_ProductWorkSnPropertyList ";
            querySql = querySql + " " + GetQueryCondition();
            $.ajax({
                type: "Get",
                url: "ProductWorkSnPropertyList.aspx",
                ...
                success: function(result) {
                    ...
                    if (result != "") {
                        ...
                        $(".tablesorter tbody tr").click(function() {
                            ...
                            $("#hdWorkSn").val($(this).find("td:eq(5)").html());
                            $("#lbWorkSn").html($(this).find("td:eq(5)").html());
                        });
        ...
        $(document).ready(function() {
            $("#btnProductWorkSnProperty").click(function() {
                $("#showOne").show();
                $("#showTwo").hide();
            });
            $("#btnProductWorkSnCoefficient").click(function() {
                var template1 = "<li><iframe style='position: relative; background-color: transparent;' width='100%' height='500' frameborder='0' src='ProductWorkSnCoefficientList.aspx?ProductNumber={0}&Version={1}&WorkSnNumber={2}'> </iframe></li>";
                var ProductNumber = $("#hdProduct").val();
                var Version = $("#hdVersion").val();
                var WorkSnNumber = $("#hdWorkSn").val();
                if (ProductNumber == "" || ProductNumber == null || Version == "" || Version == null || WorkSnNumber == "" || WorkSnNumber == null) {
                    alert("请选择产品工序！");
                    return;
                }
                $("#showOne").hide();
                $("#showTwo").show().html(template1.format(ProductNumber, Version, WorkSnNumber));
            });
            //查询
            ...
            $("#btnDelete").click(function() {
                ...
                if (confirm("确定删除选择的数据?")) {
                    //通用删除
                    DeleteProductProperty("../ProduceManager/ProductWorkSnPropertyList.aspx", ProductNumber, Version, ConvertsContent(checkResult), "btnSearch");
                }
            });
            ...
            $("#btnAdd").click(function() {
                ...
                OpenDialog("AddOrEditProductWorkSnProperty.aspx?ProductNumber=" + ProductNumber + "&Version=" + Version, "btnSearch", "490", "650");
            });
...
<body style="background-color: #f3ffe3;">
    ...
    <div>
        <div>
            ...
            <input type="hidden" id="hdWorkSn" runat="server" />
            <div style="margin-top: 15px; text-align: center; font-size: 14px;">
                产成品:<label id="lbProduct" style="color: Green;"></label>
                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 版本:<label id="lbVersion" style="color: Green;"></label>
                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 工序编码:<label id="lbWorkSn" style="color: Green;"></label>
            </div>
            <div style="float: left; margin-left: 20px;">
                <input type="button" id="btnProductWorkSnProperty" value=" 产品工序信息 " />
                <input type="button" id="btnProductWorkSnCoefficient" value=" 产品工序系数 " /></div>
                                        ...
                                        <table class="tablesorter" cellpadding="1" cellspacing="1" width="1220px">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th sortname='工序编码'  >
                                                        工序编码<span><img src="../Img/bg.gif" id="Img5" /></span>
                                                    </th>
                                                    <td>
                                                        工序名称
                                                    </td>
                                                    <th sortname='序号'>
                                                        序号<span><img src="../Img/bg.gif" id="Img6" /></span>
                                                    </th>
                                                    <th sortname='额定工时'>
