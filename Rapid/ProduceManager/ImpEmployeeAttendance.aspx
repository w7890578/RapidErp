<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImpEmployeeAttendance.aspx.cs"
    Inherits="Rapid.ProduceManager.ImpEmployeeAttendance" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 50px;">
            友情提示：导入前请检查Excel中，姓名是否存在于用户表！ <br />
            <a href="../Text/考勤上报模板.xls" title="最新模版，请点此下载！">员工考勤导入模版.xls</a>
        <br /></div>
        <div>
