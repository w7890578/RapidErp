...
{
    public partial class PerformanceReviewMonthReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Request["istrace"] != null && Request["istrace"].ToString() == "true")
                {
                    Page.Trace.IsEnabled = true;
                }

                drpYear.SelectedValue = DateTime.Now.Year.ToString();
                //string sql = string.Format(@" select ROW_NUMBER ()over(  order by 总分 desc)as 名次 ,* from V_PerformanceReviewMonthReport_List where 年份='{0}'", DateTime.Now.ToString("yyyy"));
                BindRepter();
            }
        }
...
left join (select  YEAR,name,PerformanceReviewItem ,score as '1月' from PerformanceReviewLog where [MONTH] ='1' and [Year]='{0}' and Type='生产') temp1 
on pf.Name =temp1 .Name and pf.PerformanceReviewItem =temp1 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '2月' from PerformanceReviewLog where [MONTH] ='2' and [Year]='{0}' and Type='生产') temp2 
on pf.Name =temp2 .Name and pf.PerformanceReviewItem =temp2 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '3月' from PerformanceReviewLog where [MONTH] ='3' and [Year]='{0}' and Type='生产') temp3 
on pf.Name =temp3 .Name and pf.PerformanceReviewItem =temp3 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '4月' from PerformanceReviewLog where [MONTH] ='4' and [Year]='{0}' and Type='生产') temp4 
on pf.Name =temp4 .Name and pf.PerformanceReviewItem =temp2 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '5月' from PerformanceReviewLog where [MONTH] ='5' and [Year]='{0}' and Type='生产') temp5
on pf.Name =temp5 .Name and pf.PerformanceReviewItem =temp5 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '6月' from PerformanceReviewLog where [MONTH] ='6' and [Year]='{0}' and Type='生产') temp6 
on pf.Name =temp6 .Name and pf.PerformanceReviewItem =temp6 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '7月' from PerformanceReviewLog where [MONTH] ='7' and [Year]='{0}' and Type='生产') temp7 
on pf.Name =temp7 .Name and pf.PerformanceReviewItem =temp7 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '8月' from PerformanceReviewLog where [MONTH] ='8' and [Year]='{0}' and Type='生产') temp8
on pf.Name =temp8.Name and pf.PerformanceReviewItem =temp8.PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '9月' from PerformanceReviewLog where [MONTH] ='9' and [Year]='{0}' and Type='生产') temp9
on pf.Name =temp9 .Name and pf.PerformanceReviewItem =temp9 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '10月' from PerformanceReviewLog where [MONTH] ='10' and [Year]='{0}' and Type='生产') temp10
on pf.Name =temp10 .Name and pf.PerformanceReviewItem =temp10 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '11月' from PerformanceReviewLog where [MONTH] ='11' and [Year]='{0}' and Type='生产') temp11 
on pf.Name =temp11.Name and pf.PerformanceReviewItem =temp11 .PerformanceReviewItem 
left join (select  YEAR,name,PerformanceReviewItem ,score as '12月' from PerformanceReviewLog where [MONTH] ='12' and [Year]='{0}' and Type='生产') temp12
on pf.Name =temp12 .Name and pf.PerformanceReviewItem =temp12 .PerformanceReviewItem 
) ) te where 考核类型!='库房及其它' and 年份='{0}') T group by 年份,姓名
...
from ({0}) t inner join ({1}) a on t.年份=a.年份 and t.姓名=a.姓名 ", sql, tempSql);
            ...
            //   ProductManager.WriteAverageForYear(drpYear.SelectedValue, "绩效", "是", sql, "姓名");
            return sql;
        ...
        protected void btnExcel_Click1(object sender, EventArgs e)
        {
            ...
            string sql = GetSql();
            Page.Trace.Warn(sql);
            // ToolCode.Tool.ExpExcel(sql, "员工绩效报表");
            DataView dt = Compute();
            ExpExcel(dt, "生成员工绩效报表");
        ...
        protected DataView Compute()
        {
           // 库房及其它
            ...
            string sql = string.Format("select distinct Name from PerformanceReviewLog where [year]='{0}' and type!='库房及其它'", year);
...
select SUM(isnull(score,0)) from PerformanceReviewLog where [YEAR]='{0}' and [MONTH]='{1}' and type!='库房及其它' and name='{2}'
group by [YEAR],[MONTH]),0) as '{1}'", year, i, dr["Name"]);
                }
            }
