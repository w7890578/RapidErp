<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrepaidAdvanceLookOver.aspx.cs"
    Inherits="Rapid.FinancialManager.PrepaidAdvanceLookOver" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Detail(ordersnumber, createtime) {
            window.location.href = "../SellManager/PrepaidAdvanceApplicationDetail.aspx?OrdersNumber=" + ordersnumber + "&ck=3&time=" + new Date();
        }
        function Edit(guid) {
            OpenDialog("../FinancialManager/EditPrepaidAdvanceCheck.aspx?Guid=" + guid, "btnSearch", "400", "600");
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="display: <%#Eval("销售订单号").ToString().Equals("合计") ? "none" : "inline"%>;">
                                    <a href="###" onclick="Edit('<%#Eval("Guid")%>')">编辑</a> <a href="###" onclick="Detail('<%#Eval("销售订单号")%>')">
                                        详细</a></span>
                            </td>
                        </tr>
                    </ItemTemplate>
