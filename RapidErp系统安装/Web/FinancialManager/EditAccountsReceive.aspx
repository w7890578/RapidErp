<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAccountsReceive.aspx.cs" Inherits="Rapid.FinancialManager.EditAccountsReceive" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpKP" runat="server">
          ...
          <tr>
            ...
            <td>
                <asp:TextBox ID="txtActualMakeCollectionsAmount" runat="server" ></asp:TextBox>
