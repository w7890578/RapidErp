<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsReceivableList.aspx.cs"
    Inherits="Rapid.FinancialManager.AccountsReceivableList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetQueryCondition() {
            ...
            if (customerid != "" ) {
                condition += " and 客户编号 like '%" + customerid + "%' ";
            }
            if (productnumber != "") {
        ...
        function ImpExecl() {
            querySql = " select * from V_AccountsReceivable  ";
        ...
        function GetData(pageIndex, sortName, sortDirection) {
            ...
            $.ajax({
                type: "Get",
                url: "AccountsReceivableList.aspx",
        ...
        $(document).ready(function() {
            ...
            //进入页面加载数据
            $("#btnSearch").click();
//            BindSelect("ReceivOrdersNumber", "slOrdersNumber");
//            BindSelect("ReceivaCustomerId", "slCustomerId");
        });
            ...
            <div>
                ...
                <table class="pg_table" style="margin:20px 10px 0px 0px">
                    ...
                    <tr>
                        <td colspan="13">
                            <div>
                                <table class="tablesorter" cellpadding="1" cellspacing="1" width="1800px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th sortname='客户名称'>
                                                客户名称<span><img src="../Img/bg.gif" id="Img4" /></span>
                                            </th>
                                            <th sortname='数量'>
                                            ...
                                            <th sortname='实际收款金额'>
                                                实际收款金额<span><img src="../Img/bg.gif" id="Img15" /></span>
                                            </th>
                                            <th sortname='实际收款日期'>
                                                实际收款日期<span><img src="../Img/bg.gif" id="Img16" /></span>
                                            </th>
                                            <th sortname='待收款金额'>
                                                待收款金额<span><img src="../Img/bg.gif" id="Img17" /></span>
                                            </th>
                                            <td>
                                                是否结清
                                            </td>
