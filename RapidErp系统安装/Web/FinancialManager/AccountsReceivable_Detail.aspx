<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountsReceivable_Detail.aspx.cs"
    Inherits="Rapid.FinancialManager.AccountsReceivable_Detail" %>
    ...
    <script type="text/javascript">
        $(function() {
            $("#btnBack").click(function() {
                window.location.href = "AccountsReceivable_Main.aspx";
            });
        })
    </script>
